describe('Dashboard', () => {
  describe('When logged in', () => {
    ...
    it('Load dashboard after login', () => {
      ...
      cy.get('.dashboard-summary-card').eq(2).find('.summary-type-title').should('have.text', 'Media');
      cy.get('.dashboard-summary-card').eq(3).find('.summary-type-title').should('have.text', 'Others');
    });
